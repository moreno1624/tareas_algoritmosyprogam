...
función ={"malicioso":"reduce la defensa", "ascuas": "daño de tipo fuego", "placaje": "daño de tipo normal"} 
...
while PS_jugador>0 and PS_oponente >0:
    ...
    if ataque_jugador == ataques[0]:
        ...
        print(  "Que estas haciendo, tus ataques son ", ataques  )
        print(" Sus determinadas funciones son", función)
        continue
